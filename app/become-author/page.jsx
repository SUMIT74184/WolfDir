...
const testimonials = [
  {
    ...
    earnings: "$4,200",
    quote: "Blogify has transformed my writing career. I've built an audience of 50K+ readers.",
  },
  {
    name: "Marcus Johnson",
  ...
  },
  {
    ...
    earnings: "$5,100",
    quote: "I've earned more from Blogify in 6 months than years of freelancing.",
  },
]
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold text-foreground">Why Write on Blogify?</h2>
          ...
          {step === 1 && (
            <Card className="border-border">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Apply to become a Blogify author and start earning from your expertise.
                </CardDescription>
              </CardHeader>
