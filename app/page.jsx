        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            <Badge className="mb-6" variant="secondary">
              <Star className="mr-1 h-3 w-3" /> Over 50,000 writers trust Blogify
            </Badge>
            ...
            <p className="mt-6 text-pretty text-lg text-muted-foreground sm:text-xl leading-relaxed">
              Join our community of passionate writers and curious readers. Share your stories, discover new
          ...
          <div className="relative overflow-hidden rounded-2xl bg-primary p-8 sm:p-12 lg:p-16">
            ...
            <div className="relative mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-pretty text-lg text-primary-foreground/80 leading-relaxed">
                Join thousands of writers earning from their passion. Get paid for your expertise, build your audience,
                and make an impact.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { label: "Stories Published", value: "200K+", icon: BookOpen },
